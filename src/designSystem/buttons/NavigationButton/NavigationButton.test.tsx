...
describe("Navigation Button", () => {
  test("Back button", async () => {
    ...
    expect(
      queryByTestId("navigation-button-back-chevron-right")
  ...
  test("Forward button", async () => {
    ...
    expect(
      getByTestId("navigation-button-forward-chevron-right")
    ).toBeVisible();
    expect(
      queryByTestId("navigation-button-forward-chevron-left")
    ).not.toBeInTheDocument();
  });
});
